      ...
      <footer className="pt-28 text-center lg:text-left blue-background text-white mt-15 ">
        <div className="py-10 text-center md:text-left w-3/4 mx-auto">
          ...
          <div className="grid grid-flow-row-dense grid-cols-1 lg:grid-cols-5 grid-rows-1">
            <div className="text-center lg:text-left mt-2 mb-2">
              ...
              <p className="mb-4">
                <Link href="https://www.dypiemr.ac.in">
              ...
              <p className="mb-4">
                <Link href="http://csi-india.org.in/">
                  <a target="_blank" className="text-white">
                    CSI India
                  </a>
                </Link>
              ...
              <p className="mb-4">
                <Link href="https://www.linkedin.com/company/csi-dypiemr">
                  <a target="_blank" className="text-white">
                    Linkedin Page
                  </a>
                </Link>
          ...
          "
              ...
              <p>
                D. Y. Patil Educational Complex, Akurdi, Sector 29, Ravet
                Village Rd, Gurudwara Colony, Nigdi, Pimpri-Chinchwad,
                Maharashtra 411044
              </p>
            </div>
            <div className="mt-2 mb-2">
              ...
              <p className="flex items-center justify-center md:justify-start mb-4">
                ...
                <span className="text-red-400 font-bold">
                  <Link href="mailto:csi.comp@dypiemr.ac.in">
                    <a> csi.comp@dypiemr.ac.in</a>
              ...
              <div className="flex justify-start lg:justify-start md:justify-start sm:justify-center">
        ...
        <div className="text-center p-6 blue-background">
          <span className="font-semibold">
            Copyright of Computer Society of India, DYPIMER 2021-22. All rights
            reserved. © 2021 Copyright:
          </span>
        </div>
      </footer>
    </div>
